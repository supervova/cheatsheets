[Промис](https://learn.javascript.ru/promise-basics){:target="_blank"} (promise; термин не переводится) – это специальный объект, который связывает «создающий» и «потребляющий» код.
